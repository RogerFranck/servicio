 ...
 <body>
	...
	<br><br>
			...
			<div class="container" style="width: 25em;">
				...
				<?php  $select = mysqli_query($conexion,"SELECT * FROM `ynagrupos`"); 
			    ...
			    <tr>
			      <td><?php echo $mostrar['semestre']." ".$mostrar['grupo']." ".$mostrar['especialidad']." ".$mostrar['turno'] ?></td>
			      <td><center><a href="adminGrupoEliminar.php?mat=<?php echo $mostrar['id_grupos'] ?>"><img src="https://image.flaticon.com/icons/svg/458/458594.svg" width="25px;"></a></center></td>
			    </tr>
